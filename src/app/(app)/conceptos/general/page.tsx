...
export default function ConceptosGeneralPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Catálogo general · Precios base</h1>
          <p className="text-sm text-slate-400">
            Estos son los precios por default. Cuando un tramo no tiene precio especial, se cobra este.
          </p>
        </div>
